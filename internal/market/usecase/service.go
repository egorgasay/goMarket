...
type IUseCase interface {
	...
	ChangeOrderStatus(ctx context.Context, statusCode int, orderID string) error
	GetOrder(ctx context.Context, username string, id string) (order schema.Order, err error)
}
